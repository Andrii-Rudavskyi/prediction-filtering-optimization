...
llsFilterParameters = LLSFilterParameters(dataPath=dataPath, filterType=FilterType.WeavingPoseFilter, useNoiseRejection=True)

llsfilter = LLSfilter(dataPath=dataPath, llsFilterParameters=llsFilterParameters, debuPlots=False)
